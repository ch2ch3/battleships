...
describe FiringBoard do
	...
	let (:firing_board  ) { FiringBoard.new(linked_ship_board) }
	let (:linked_ship_board ) { double :ship_board, hit_at?: nil, extension: 9, depth: 2     }

	it "is linked with a ship board" do
